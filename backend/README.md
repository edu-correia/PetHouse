...
- Yarn (usado dentro do docker): [https://classic.yarnpkg.com/lang/en/docs/install/#debian-stable](https://classic.yarnpkg.com/lang/en/docs/install/#debian-stable)
- npm

### How to install dependencies:
We will be using npm in this project, please do not use any other package manager to add or remove dependencies. <br>

To install all dependencies listed on **package.json**, just use: `npm install` in the `backend/` folder.
